...
# Try modifying the code below by adding the numbers for a sixth cabin into the data
# so that you have the following data set
# size, size of the sauna, distance to water, indoor bathrooms, proximity of neighbors,price in € (output)
